...
--
-- It contains migrations 0001-0020 plus the development seed, in order, wrapped
...
-- ==========================================================================
-- supabase/migrations/0018_trial_gate.sql
-- ==========================================================================
...
-- ==========================================================================
-- supabase/migrations/0020_client_invite.sql
-- ==========================================================================
...
-- =============================================================================
-- Verification — expect: 19 tables, 19 rls enabled, 31 policies, 0 anon
-- policies, 19 tables granted to service_role, 1 tenant, 4 event types,
...
-- 0 AI usage events (the seed never calls the AI feature), 5 email
-- templates (the trigger's own defaults — the seed doesn't customise any),
-- 1 client, 1 client entitlement.
-- =============================================================================
...
union all select 'client entitlements', count(*)::text from client_entitlements;
